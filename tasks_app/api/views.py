...
class TaskAssignedToMeView(ListCreateAPIView):
    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            if not queryset.exists():
                return Response(
                    {"detail": "Erfolgreich. Gibt eine Liste der Tasks zurück, die dem aktuell authentifizierten Benutzer entweder als Bearbeiter oder als Prüfer zugewiesen sind."},
                    status=status.HTTP_200_OK
                )
